...
- **Status:** Accepted (ruled by Palash, 2026-07-18). Build order: time features → List follow-up → **this**.
- Full scoping + citations: [docs/plan-project-context-ai.md](../plan-project-context-ai.md).
